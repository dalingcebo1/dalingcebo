...
export default function LargePaintings() {
  ...
  const renderGridView = () => (
    <PageShell
      ...
      subtitle="Statement pieces that command attention and transform spaces."
      breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Shop', href: '/shop' }, { label: 'Large Paintings' }]}
    >
      ...
      <div className="mt-12 pt-8 border-t border-gray-200 text-center">
        ...
        <Link href="/small-paintings" className="btn-yeezy inline-block">
          View Small Paintings
        </Link>
      </div>
    </PageShell>
  )
